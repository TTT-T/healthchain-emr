...
export default function ExternalRequestersHeader({ title, subtitle, onToggleSidebar }: ExternalRequestersHeaderProps) {
        ...
        <div className="flex items-center gap-4 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-lg lg:text-xl font-semibold text-gray-900 flex items-center gap-2 truncate">
              <Building2 className="text-emerald-600 flex-shrink-0" size={20} />
        ...
        <div className="flex items-center gap-2 lg:gap-3 flex-shrink-0">
          ...
          <div className="hidden lg:flex relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 w-48 xl:w-64 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
            />
          </div>
          ...
          <div className="relative group flex-shrink-0">
            <button className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg transition-colors">
              ...
              <div className="hidden xl:block text-left">
                <div className="text-xs font-medium text-gray-900">External User</div>
            ...
            <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="p-2">
                <div className="px-3 py-2 border-b border-gray-100">
                  <div className="font-medium text-gray-900 text-sm">External User</div>
                  <div className="text-xs text-gray-500">external@healthchain.com</div>
                </div>
