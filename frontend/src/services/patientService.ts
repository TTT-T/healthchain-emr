      ...
      if (type === 'hn') {
        ...
        if (response.statusCode === 200 && response.data && (response.data as any).patients) {
          ...
          const flattenedPatients = (response.data as any).patients.map((patient: any) => ({
            ...
            thaiName: patient.personal_info?.thai_first_name,
            thaiFirstName: patient.personal_info?.thai_first_name,
            ...
            currentMedications: patient.medical_info?.current_medications,
