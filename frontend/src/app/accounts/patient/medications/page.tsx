                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div className="space-y-1">
                        ...
                        <p><span className="font-medium text-gray-700">วันที่สั่งจ่าย:</span> <span className="text-gray-900">{new Date(medication.prescription.date).toLocaleString('th-TH')}</span></p>
            ...
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-300 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-500 pt-4 border-t border-gray-200">
                  <p>วันที่สั่งจ่าย: {new Date(selectedMedication.prescription.date).toLocaleString('th-TH')}</p>
